...
# 指定目录路径
directory_path = "./music/"  # 请将路径替换为实际的目录路径

# 指定备份目录
bak_path = "./bak/"  # 请将路径替换为实际的目录路径

# 构建URL的基本部分
base_url = "https://github.com/CaoeUU/Music/raw/main/music/"  # 请将路径替换为实际的目录路径
base_lrc_url = "https://raw.githubusercontent.com/CaoeUU/Music/main/music/"  # 请将路径替换为实际的目录路径
# 获取目录中的所有文件名
file_names = [
    file
